		...
		var main = function (){
			...
			layui.each(filters, function(i, filter){
				...
				filterIcon.on("click", function(e) {
					...
					filterBox.find('form').append('<button class="layui-btn layui-btn-normal layui-btn-sm" lay-submit lay-filter="tableFilter">OK</button>');
					filterBox.find('form').append('<button type="button" class="layui-btn layui-btn-primary layui-btn-sm filter-del layui-btn-disabled" disabled>Cancel</button>');
