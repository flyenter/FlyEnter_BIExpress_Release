    ...
    tableSelect.prototype.render = function (opt) {
        ...
        elem.off('click').on('click', function(e) {
            ...
            var tableBox = '<div class="tableSelect layui-anim layui-anim-upbit" style="left:'+l+';top:'+t+';border: 1px solid #d2d2d2;background-color: #fff;box-shadow: 0 2px 4px rgba(0,0,0,.12);padding:10px 10px 0 10px;position: absolute;z-index:66666666;margin: 5px 0;border-radius: 2px;min-width:530px;">';
                ...
                tableBox += '</form>';
                tableBox += '<button style="float:right;" class="layui-btn layui-btn-sm tableSelect_btn_close">Close<span></span></button>';
                tableBox += '<button style="float:right;margin-right: 5px;" class="layui-btn layui-btn-sm tableSelect_btn_Clean">Clean<span></span></button>';
                tableBox += '<button style="float:right" class="layui-btn layui-btn-sm tableSelect_btn_select">Choose<span></span></button>';
                tableBox += '</div>';
                //tableBox += '<table id="' + tableName + '" lay-filter="' + tableName + '"></table>';
                tableBox += '<div class="layui-container">';
                tableBox += '  <div class="layui-row">';
                tableBox += '    <div class="layui-col-md9">';
                tableBox += '       <table id="' + tableName + '" lay-filter="' + tableName + '"></table>';
                tableBox += '    </div>';
                tableBox += '    <div class="layui-col-md3">';
            ...
            tableBox.find('.tableSelect_btn_Clean').on('click', function () {
                ...
                tableBox.find('.tableSelect_btn_search').click();
